    ...
    <div className="min-h-screen flex items-center justify-center p-4 grid-bg" style={{ background: 'var(--bg-primary)' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black font-display text-[#f0f0ff]">Bon retour 👋</h1>
          <p className="text-sm text-[#8888aa] mt-1">Connecte-toi à ton compte SwapLive</p>
        </div>
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-1">
                <Link href="/forgot-password" className="text-xs text-[#00d4ff] hover:underline">Mot de passe oublié ?</Link>
              </div>
            </div>
          ...
          <button className="mt-4 w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-white/10 text-sm text-[#8888aa] hover:bg-white/5 transition-colors">
